...
import {PhotoChatMessage, Gradient, VideoBar, VideoChatMessage} from "../components/design/design/Services";
  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        ...
        p-8 border-n-1/10 border rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]"
          >
            <div
            ...
            <Generating
              className="absolute left-4 border border-n-1/10
               right-4 bottom-4 lg:left-1/2  lg:bottom-8 lg:-translate-x-1/2"
            />
          </div>
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            ...
            >
              ...
              >
                ...
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos using out AI app's photo
                  editing feature. Try now!
                </p>
              </div>
              <PhotoChatMessage />
            </div>
